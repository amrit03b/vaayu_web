...
import { Gift, User as UserIcon, Wallet, FileText, Copy, CheckCircle, ArrowRight, Settings, Heart, MapPin, Clock } from "lucide-react"
import Link from "next/link"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { Button } from "@/components/ui/button"
import { Badge } from "@/components/ui/badge"
import { AQIAlertCard } from "@/components/AQIAlertCard"
import { getStoredWallet, getUserProfile, hasUserProfile, type HealthProfile } from "@/lib/aptos"
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchHealthProfile = async () => {
      ...
      try {
        const hasProfileResult = await hasUserProfile(wallet)
